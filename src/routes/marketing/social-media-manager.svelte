...
<script>
  ...
  <div class="inside-hero-three bg-color">
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-6">
                  <h2 class="page-title font-recoleta">Boost Your Brand with<span>Bumble Bees</span> Social Media Magic</h2>
              </div>
              <div class="col-xxl-5 col-md-6 ms-auto">
                  <p>At Bumble Bees IT Solutions, our Social Media Managers specialize in creating buzzworthy online experiences. Here's why we stand out.</p>
              </div>
          </div>
      </div>
  </div>
  ...
  <div class="vcamp-text-block-thirteen pt-150 mb-130 lg-pt-100 lg-mb-80">
      <div class="container">
          ...
          <div class="row mb-40">
              <div class="col-lg-12">
                  <p class="lead">Elevate your brand's social media presence with Bumble Bees IT Solutions, where strategic management meets engaging content creation. We go beyond ordinary social media practices; we create digital experiences that leave a lasting impression.</p>
              </div>
          </div>
          ...
          <div class="row mt-5">
              <div class="col-lg-6">
                  ...
                  <ul class="ui-list-item-one style-none">
                      <li><strong>Strategic Expertise:</strong> Crafted social media strategies that align with your brand goals and resonate with your audience.</li>
              ...
              <div class="col-lg-6">
                  ...
                  <ul class="ui-list-item-one style-none">
                      <li><strong>Brand Visibility:</strong> Boosting your brand's visibility through carefully curated social media campaigns and interactions.</li>
                      ...
                      <li><strong>Responsive Engagement:</strong> Ensuring timely and meaningful interactions with your audience across all social channels.</li>
                  </ul>
              </div>
          </div>
          ...
          <div class="row mt-5">
              <div class="col-lg-12">
                  <p>Partner with Bumble Bees IT Solutions for social media management that doesn't just meet industry standards; it redefines them. Ready to boost your brand's social success? Contact us today.</p>
              </div>
          </div>
      </div>
  </div>
  ...
  <!-- <p class="text-center">In <span> Partnership </span> Your Trusted and Authorized Collaborator.</p> -->

  <!-- style="padding: 0 1.3rem;" -->

  <!-- style="opacity: 1; width: {logos.length * 198}px; transform: translate3d(0px, 0px, 0px);" -->
